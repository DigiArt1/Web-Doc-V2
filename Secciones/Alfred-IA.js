            ...
            const requestBody = {
                contents: [{
                    parts: [{
                        ...
                        si te las piden si quieren hablar  sobre un a consulta o algo dales un enlace de redirecion a este numero +573188042578  y esta es la direcion Avenida Roosevelt Calle 6ta # 26 - 59 
                        ...
                        Tu creador Es Andrés Hincapié Programador principal del equpo de Digi Art Creativo junto con Jadinzon Diaz, y Encabezando el equipo Samuel Herrara El Gerente general esta es la web https://digiartcreativo.com/ Aquí está la pregunta del usuario: ${message}`
                    }]
                }],
                generationConfig: {
                    temperature: 0.7,
